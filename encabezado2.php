        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../Avance_Proyecto/contacto/index.php" style="color:white;">Contáctanos</a>
                    </li>
                ...
                <div class="navbar-end">
                    ...
                    <div class="navbar-item">
                        <div class="buttons">
                            ...
                            <?php if(isset($name)){echo '<h5 class="title_menu" style="color: white">'.$name.'</h5>';}?>
                        </div>
                    </div>
                </div>
            </div>
